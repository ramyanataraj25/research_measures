...
def process_subjects_to_csv(input_file, output_csv):
    ...
    '/Users/ramyanataraj/Documents/Research/research_measures/src/get_pseudoword_measures.R'], check=True)
        
        subprocess.run(['Rscript', 
'/Users/ramyanataraj/Documents/Research/research_measures/src/syllableValues.r']
                   , check=True)
